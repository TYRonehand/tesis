...
public class UsersList extends Composite {
	...
	@UiField Button modalSearchTopic;
	@UiField Button modalNewestTopic;
	@UiField Button modalOldestTopic;
	...
	//------------------------------------
		...
		private void LoadTable(List<User> DATAINFO)
		{
			...
			table.addColumn(dateColumn, "Lastname");
			...
			table.addColumn(addressColumn, "Email");

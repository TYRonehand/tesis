...
public class SignupWidget extends Composite {
	...
	private void SignUp() {
		if (passInput.getText().equals(pass2Input.getText())
				&& FieldVerifier.isValidMail(mailInput.getText())
				&& FieldVerifier.isValidName(nameInput.getText())
				&& FieldVerifier.isValidName(lastnameInput.getText())) {
			serverService.userExist(mailInput.getText(),
					new AsyncCallback<Boolean>() {
						...
						public void onSuccess(Boolean result) {
							...
							if (!result) {
								// save data in object
								/*String id, String mail, String name, String lastname,

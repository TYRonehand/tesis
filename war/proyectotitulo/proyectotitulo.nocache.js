...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "proyectotitulo" because\n';
  ...
  $wnd.__gwt_activeModules['proyectotitulo'] = {
    'moduleName' : 'proyectotitulo',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/proyectotitulo.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['proyectotitulo'].superdevmode = true;

  var expectedSuffix = '/proyectotitulo.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + proyectotitulo + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:proyectotitulo';
  var devModeSessionKey = '__gwtDevModeSession:proyectotitulo';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/proyectotitulo/proyectotitulo.nocache.js';
  ...
  $wnd.__gwt_activeModules['proyectotitulo'].canRedirect = true;
  $wnd.__gwt_activeModules['proyectotitulo'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING proyectotitulo';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/proyectotitulo?user.agent=' + ua + '&_callback=' + callback;
